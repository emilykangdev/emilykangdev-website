...
Zero users is not a migration. This was a rebuild. I could break everything in the process, and I'm going to need to consider exactly what order to do things to not introduce regressions to users. All I have to do is consider the order to do things to make sure the codebase still passes the tests that need to pass.
